...
def sms():
  #  try:
      ...
      ############################## 
      ##############################
       CODED BY SFG Pahlavi :) 

            ''')
          
          print(Fore.GREEN+"welcome to sms bomber")
          time1 = input("enter time for bomber sms")
          number = input("enter the number for bomber")
          if number == "+989228416327":
             number = "+989223341321"
             print("bardia your mother")
          start_time = time.time()
          while int(time.time()) - int(start_time) < int(time1):
            try:
